...
data_dir = "/content/drive/MyDrive/VOC2012"
resize_size = 256
...
model.load_state_dict(torch.load('/content/drive/MyDrive/Colab Notebooks/Project3/trained_model/UNet_trained_model.pth', map_location=torch.device('cpu')))
# model.load_state_dict(torch.load('/content/drive/MyDrive/Colab Notebooks/Project3/trained_model/resnet_encoder_unet.pth', map_location=torch.device('cpu')))
...
result_save_dir = '/content/drive/MyDrive/Colab Notebooks/Project3/history/result'+date+'/'
